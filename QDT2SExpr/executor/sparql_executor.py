...
def get_entity_labels():
    entities_list = load_json('/home3/xwu/workspace/QDT2SExpr/CWQ/data/WebQSP/entity_linking_0423/WEBQSP_merged_elq_FACC1_label_map_missed_entities.json')
    res = dict()
    count = 0
    for entity in entities_list:
        ...
        res[entity] = label
    dump_json(res, '/home3/xwu/workspace/QDT2SExpr/CWQ/data/WebQSP/entity_linking_0423/WEBQSP_merged_elq_FACC1_extra_label_map.json')
