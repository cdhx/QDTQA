...
import sys
sys.path.append("/home2/xxhu/QDT2SExpr/common")
...
if __name__=='__main__':
    ...
    # sexpr = '(JOIN dbo:director dbr:Stanley_Kubrick)'
    sexpr = '(AND dbo:City (JOIN dbo:founder dbr:John_Forbes_British_Army_officer))'
