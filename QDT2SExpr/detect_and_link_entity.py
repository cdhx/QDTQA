...
# use EARL to perform entity linking
...
def dump_entity_linking_results_for_WEBQSP(split,keep=10):
    ...
    # 5. dump the entity linking results
    with open(f'data/WEBQSP_{split}_entities.json',encoding='utf8',mode='w') as f:
...
def dump_entity_linking_results_from_elq_for_CWQ(split, keep=10):
    ...
    with open(f'data/cand_entities/CWQ_{split}_cand_entities_elq.json',encoding='utf8',mode='w') as f:
        json.dump(el_results, f, indent=4)
...
def dump_entity_linking_results_from_elq_for_WEBQSP(split, keep=10):
    ...
    # 2. dump the entity linking results
    with open(f'data/cand_entities/WEBQSP_{split}_cand_entities_elq.json',encoding='utf8',mode='w') as f:
        json.dump(el_results, f, indent=4)
